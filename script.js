document.addEventListener("DOMContentLoaded", () => {
       ...
       const moveSound = new Audio("https://cdn.freesound.org/previews/171/171104_71257-lq.mp3");
       const checkSound = new Audio("https://cdn.freesound.org/previews/562/562345_11818947-lq.mp3");
       const checkmateSound = new Audio("https://cdn.freesound.org/previews/530/530920_10877482-lq.mp3");
         ...
         for (let y = 0; y < 8; y++) {
           for (let x = 0; x < 8; x++) {
             ...
             if (piece && !fadingPieces.some(p => p.x === x && p.y === y)) {
               ...
               ctx.font = `${size * 0.7}px Arial, sans-serif`; /* Zurück zu Arial */
